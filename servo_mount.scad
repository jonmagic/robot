...
module servo_mount() {
  ...
  difference() {
    ...
    translate([0.4,3,5]) rotate([0,90,0]) sunk_screw(3);
    translate([0.4,3,15]) rotate([0,90,0]) sunk_screw(3);
    translate([2.6,3,5]) rotate([0,90,0]) sunk_screw(3);
    translate([2.6,3,15]) rotate([0,90,0]) sunk_screw(3);
  }
}
